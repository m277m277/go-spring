# starter-gorm-postgres Cloud-Native Example

A flagship for starter-gorm-postgres composing the cloud-native capability set
...
`check.sh` brings up PostgreSQL via docker compose, then asserts health probes
are UP, a discovery-resolved query succeeds, a burst is partly rejected with
