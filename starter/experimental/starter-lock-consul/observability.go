...
// OTel client spans (lock.system="consul"). The implementation lives in the
...
func WrapLocker(inner lock.Locker) lock.Locker { return lockobserve.WrapLocker("consul", inner) }
