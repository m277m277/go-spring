#!/usr/bin/env bash
#
# Smoke test for the starter-mongodb cloud-native flagship. Brings up a local
# MongoDB via docker compose, runs the example (which self-asserts health,
...
# Wait for MongoDB to accept connections (up to 60s). mongo binds 27017/tcp.
